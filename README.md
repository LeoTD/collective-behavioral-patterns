...
*   **`estimators/`**: Contains the frozen (HDFC-E), instrumented (HDFC-I), and revised (HDFC-R) code for HDFC, which achieved a top MSE of 0.0010912 against the ground truth. Also contains a range of standard estimators used for testing.
